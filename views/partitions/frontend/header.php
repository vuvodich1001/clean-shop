            ...
            <nav>
                ...
                <div class="nav-auth">
                    ...
                    <div class="nav-auth-body">
                        <button class="btn-auth btn-login">Đăng nhập</button>
                        <button class="btn-auth btn-register">Tạo tài khoản</button>
                    </div>
                </div>
                ...
                <div class="nav-cart">
                    ...
                    <p class="nav-cart-quantity">
                        <?php if(session_status() === PHP_SESSION_NONE) session_start(); if(isset($_SESSION['cart'])) echo count($_SESSION['cart']); else echo 0;?>
                    </p>
                </div>
            </nav>
        </div>
